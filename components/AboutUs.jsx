...
function AboutUs() {
  const englishText = <p>We at Odessa are a freelancer group on both mobile and web development. Our main objetive is to bring the best in the technology sector, with creativity, modernism and innovation. Our vision is to grow more and more and become a reference in one of the fastest growings professional sectors around the world.</p>
  const englishTitle = 'About Us';

  return (
    <div id="about-us" className='text-white scroll-mt-24'>
